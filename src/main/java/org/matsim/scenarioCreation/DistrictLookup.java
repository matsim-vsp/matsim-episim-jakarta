...
public class DistrictLookup implements Callable<Integer> {
	...
	@CommandLine.Parameters(paramLabel = "file", arity = "1", description = "Population file", defaultValue  = "../shared-svn/projects/episim-jakarta/matsim-input-files/1pct/jakarta_population_includingHomeCoord.xml.gz")
	private Path input;

	@CommandLine.Option(names = "--shp", description = "Shapefile containing district information", defaultValue = "../shared-svn/projects/episim-jakarta/matsim-input-files/shp-file/idn_admbnda_adm1_bps_20200401.shp")
	private Path shapeFile;

	@CommandLine.Option(names = "--output", description = "Output population file", defaultValue  = "../shared-svn/projects/episim-jakarta/matsim-input-files/1pct/jakarta_population_withDistricts_reduced-for-episim.xml.gz")
	private Path output;

	@CommandLine.Option(names = "--attr", description = "Attribute name in the shapefile, which contains the district name", defaultValue = "ADM1_EN")
	private String attr;

	@CommandLine.Option(names = "--input-crs", description = "Overwrite CRS of the population home coordinates. " +
			"If not given it will be read from the population attributes.", defaultValue = "EPSG:5330")
	...
	public Integer call() throws Exception {
		...
		// shapeFile is downloaded here: https://data.humdata.org/dataset/84a1d98a-790b-4d66-9d14-bbfa48500802/resource/53625e84-203d-4331-b3eb-01e6e8344413/download/idn_adm_bps_20200401_shp.zip
